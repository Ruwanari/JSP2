      ...
      <div class="divnavigation">
          <center><table border="0" height="40px" cellspacing="0px" cellspacing="0px">
            <tr>
              ...
              <td> <a  href="stock_details.php" target="abc"><div class="button2 bt2text" >Stock</div></a> </td>
              <td> <a  href="info.php" target="abc"><div class="button2 bt2text" >Information</div></a> </td>
