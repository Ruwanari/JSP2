         ...
         <!header>
              <table border="0" cellpadding="0" cellspacing="0" height="150px" width="1150px">
                  <tr>
                    ...
                    <td height="100px" width="150px"><center><img src="../Images/FSE Images/fse.png" height="100px" width="100px"></center></td>
      ...
      <div class="divnavigation">
          <center><table border="0" height="40px" cellspacing="0px" cellspacing="0px">
            <tr>
              ...
              <td> <a  href="#stock.php" target="abc"><div class="button2 bt2text" >My Stock</div></a> </td>
              ...
              <td> <a  href="#progress.php" target="abc"><div class="button2 bt2text">Progress</div></a> </td>
